...
(function () {
  ...
  var __vue_render__ = function() {
    ...
    return _c("div", { staticClass: "app" }, [
            ...
            scopedSlots: _vm._u([
              {
                ...
                fn: function(ref) {
                  ...
                  return [
                    _c("div", [
                      _vm._v(_vm._s(index) + _vm._s(size) + " " + _vm._s(active))
                    ])
                  ]
                }
              }
      ...
      _c(
        ...
        [
          _c("virtual-scroller", {
            attrs: { items: _vm.items, direction: "horizontal" },
            scopedSlots: _vm._u([
              {
                key: "default",
                fn: function(ref) {
      ...
      _c(
        ...
        { staticClass: "table" },
        [
          _c("virtual-scroller-table", {
            attrs: { cols: _vm.items, rows: _vm.items },
            scopedSlots: _vm._u([
              {
                key: "default",
                fn: function(ref) {
                  ...
                  return [
                    _c("div", [
                      _vm._v(
                        _vm._s(colIndex) + _vm._s(colIndex) + " " + _vm._s(active)
                      )
                    ])
                  ]
                }
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-3a1824ae_0", { source: ".vertical[data-v-3a1824ae] {\n  height: 30vh;\n}\n.horizontal[data-v-3a1824ae] {\n  width: 100%;\n  height: 10vh;\n}\n.table[data-v-3a1824ae] {\n  width: 50vh;\n  height: 30vh;\n}\n", map: {"version":3,"sources":["C:\\Users\\lxw\\Desktop\\codework\\virtual-scroller\\example\\App.vue","App.vue"],"names":[],"mappings":"AAoDA;EACA,YAAA;ACnDA;ADoDA;EACA,WAAA;EACA,YAAA;AClDA;ADmDA;EACA,WAAA;EACA,YAAA;ACjDA","file":"App.vue","sourcesContent":["<template>\n    <div class=\"app\">\n        <h1>垂直滚动</h1>\n        <div class=\"vertical\">\n            <virtual-scroller :items=\"items\">\n                <template v-slot=\"{ index, size, active }\">\n                    <div>{{ index }}{{ size }} {{ active }}</div>\n                </template>\n            </virtual-scroller>\n        </div>\n        <h1>水平滚动</h1>\n        <div class=\"horizontal\">\n            <virtual-scroller\n                :items=\"items\"\n                v-slot=\"{ index, size, active }\"\n                direction=\"horizontal\"\n            >\n                <div>{{ index }}{{ size }} {{ active }}</div>\n            </virtual-scroller>\n        </div>\n        <h1>虚拟滚动表格</h1>\n        <div class=\"table\">\n            <virtual-scroller-table\n                :cols=\"items\"\n                :rows=\"items\"\n                v-slot=\"{ rowIndex, colIndex, active }\"\n            >\n                <div>{{ colIndex }}{{ colIndex }} {{ active }}</div>\n            </virtual-scroller-table>\n        </div>\n    </div>\n</template>\n\n<script>\nimport * as math from '@/utils/math.ts';\nexport default {\n    name: 'App',\n    data() {\n        return {\n            items: [],\n        };\n    },\n    methods: {},\n    mounted() {\n        for (let i = 0; i < 1000; i++) {\n            this.items.push(math.random(50, 200));\n        }\n    },\n};\n</script>\n\n<style lang=\"stylus\" scoped>\n.vertical\n  height 30vh\n.horizontal\n  width 100%\n  height 10vh\n.table\n  width 50vh\n  height 30vh\n</style>\n",".vertical {\n  height: 30vh;\n}\n.horizontal {\n  width: 100%;\n  height: 10vh;\n}\n.table {\n  width: 50vh;\n  height: 30vh;\n}\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-3a1824ae";
    /* module identifier */
  ...
  var script$1 = {
      ...
      methods: {
          ...
          handleVisibilityChange(offset, clientSize) {
              let { start, end } = findVisibleIndex(offset, clientSize, this.itemsPosition);
      ...
      computed: {
          tableSize() {
              if (this.direction === 'vertical') {
                  return {
                      minHeight: `${total(this.items, 0, -1)}px`,
                      width: '100%',
                  };
              } else {
                  return {
                      height: '100%',
                      minWidth: `${total(this.items, 0, -1)}px`,
                  };
              }
          },
          //尺寸缓存
  ...
  var script$2 = {
      ...
      methods: {
          ...
          handleScroll() {
              ...
              this.visibleRowsIndex = findVisibleIndex(
                  scroller.scrollTop,
                  scroller.clientHeight,
                  this.rowsPosition,
              );
              this.visibleColsIndex = findVisibleIndex(
                  scroller.scrollLeft,
      ...
      computed: {
          tableSize() {
              return {
                  height: `${total(this.rows, 0, -1)}px`,
                  width: `${total(this.cols, 0, -1)}px`,
              };
          },
          //长度缓存
          colsPosition() {
