...
(function () {
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-73e49c14_0", { source: ".vertical[data-v-73e49c14] {\n  height: 30vh;\n}\n.horizontal[data-v-73e49c14] {\n  width: 100%;\n  height: 10vh;\n}\n.table[data-v-73e49c14] {\n  width: 50vh;\n  height: 30vh;\n}\n", map: {"version":3,"sources":["C:\\Users\\lxw\\Desktop\\codework\\virtual-scroller\\example\\App.vue","App.vue"],"names":[],"mappings":"AAkDA;EACA,YAAA;ACjDA;ADkDA;EACA,WAAA;EACA,YAAA;AChDA;ADiDA;EACA,WAAA;EACA,YAAA;AC/CA","file":"App.vue","sourcesContent":["<template>\n    <div class=\"app\">\n        <h1>垂直滚动</h1>\n        <div class=\"vertical\">\n            <virtual-scroller :items=\"items\" v-slot=\"{ index, size, active }\">\n                <div>{{ index }}{{ size }} {{ active }}</div>\n            </virtual-scroller>\n        </div>\n        <h1>水平滚动</h1>\n        <div class=\"horizontal\">\n            <virtual-scroller\n                :items=\"items\"\n                v-slot=\"{ index, size, active }\"\n                direction=\"horizontal\"\n            >\n                <div>{{ index }}{{ size }} {{ active }}</div>\n            </virtual-scroller>\n        </div>\n        <h1>虚拟滚动表格</h1>\n        <div class=\"table\">\n            <virtual-scroller-table\n                :cols=\"items\"\n                :rows=\"items\"\n                v-slot=\"{ rowIndex, colIndex, active }\"\n            >\n                <div>{{ colIndex }}{{ colIndex }} {{ active }}</div>\n            </virtual-scroller-table>\n        </div>\n    </div>\n</template>\n\n<script>\nimport * as math from '@/utils/math.ts';\nexport default {\n    name: 'App',\n    data: function () {\n        return {\n            items: [],\n        };\n    },\n    methods: {},\n    mounted() {\n        for (let i = 0; i < 1000; i++) {\n            this.items.push(math.random(50, 200));\n        }\n    },\n};\n</script>\n\n<style lang=\"stylus\" scoped>\n.vertical\n  height 30vh\n.horizontal\n  width 100%\n  height 10vh\n.table\n  width 50vh\n  height 30vh\n</style>\n",".vertical {\n  height: 30vh;\n}\n.horizontal {\n  width: 100%;\n  height: 10vh;\n}\n.table {\n  width: 50vh;\n  height: 30vh;\n}\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-73e49c14";
    /* module identifier */
